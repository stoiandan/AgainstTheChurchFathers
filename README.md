...
The frist council at Nicea, was convoked by Emperor Constaine, to settle religious problems. Troughout time, there were many other, smaller _local councils_, convoked by _bishops_, and these greater ones. But during a period of time when the Byzantine Empire was in decline, Emperor Leo III, _called_ for another such _ecumenical council_ at [Hiera, in 754](https://en.wikipedia.org/wiki/Council_of_Hieria). This was supposed to be the _actual (first) seventh ecumenical council_, where Leo's  convictions, namely that the empire was in decline because people started to venerate _icons_ - which he saw as graven imagies - were to be uphold and _icons_, condemned as _heretical_.
...
Another eccumenical council followed in Nicea, the [Second Council of Nicea](https://en.wikipedia.org/wiki/Second_Council_of_Nicaea), where the _(first seventh) council of Hiera_, was condemned and is today no longer recognized as eccumenical council.
